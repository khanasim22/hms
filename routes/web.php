...
Route::get('2fa-verify', [TwofactorAuthenticationController::class, 'showVerifyForm'])->name('2fa.verify');
Route::post('2fa-verify', [TwofactorAuthenticationController::class, 'verify'])->name('2fa.verify.post');
...
Route::middleware('auth', 'verified', 'xss', 'checkUserStatus')->group(function () {
    ...
    Route::get('2fa-enable', [TwofactorAuthenticationController::class, 'index'])->name('enable-2fa');
    Route::post('2fa-generate', [TwofactorAuthenticationController::class, 'generateTwoFactorSecret'])->name('2fa.generate');
    Route::post('/2fa-enable-auth', [TwofactorAuthenticationController::class, 'enable2FA'])->name('2fa.enable');
    Route::post('/2fa-regenerate', [TwofactorAuthenticationController::class, 'regenerateRecoveryCodes'])->name('2fa.regenerate');
    ...
    Route::middleware('role:Admin')->group(function () {
        ...
        Route::get('queue-theme-configuration', [SettingController::class, 'patientQueueThemeView'])->name('queue-theme-view');
        Route::post('queue-theme-configuration', [SettingController::class, 'patientQueueThemeUpdate'])->name('queue-theme-update');
        Route::post('settings/upload-theme-video', [SettingController::class, 'settingsUploadThemeVideo'])->name('settings.upload-theme-video');
    ...
    Route::middleware('role:Patient')->group(function(){
        ...
        Route::get('complaint/{complaint}/edit', [ComplaintController::class, 'edit'])->name('complaints.edit');
        Route::put('complaint/{complaint}', [ComplaintController::class, 'update'])
        ->name('complaints.update');
        Route::delete('complaint/{complaint}', [ComplaintController::class, 'destroy'])->name('complaints.destroy');
    });

    // for Complaint module
    Route::middleware('role:Patient|Admin|Receptionist')->group(function(){
    ...
    Route::middleware('role:Admin|Receptionist')->group(function(){
        Route::post('complaint/update-status-response', [ComplaintController::class, 'updateStatusResponse'])
            ->name('complaints.update.status.response');
        Route::get('complaint/{complaint}/responseEdit', [ComplaintController::class, 'responseEdit'])
            ->name('complaints.responseEdit');
    });
