...
return [
    ...
    */
    ...
    'user' => [
        ...
        'please_first_create_doctor_department' => '請先創建醫生部門', 
    ],
    ...
    'complaints' => [
        ...
        'response' => '回复',
        'hold' => '抓住',
        'complaint_submitted_successfully' => '投诉已成功提交。',
        'complaint_updated_successfully' => '投诉已成功更新',
        'complaint_deleted_successfully' => '投诉已成功删除',
        'pending' => '待處理',
        'in_progress' => '進行中',
        'resolved' => '已解決',
        'rejected' => '已拒絕',
        'no_response_available' => '暫無回覆',
    ...
    'addon' => [
     ...
     'queue' => [
        ...
        'refreshing' => '正在刷新...',
        'refresh_now' => '立即刷新',
        'refreshing_in' => '将在以下时间刷新',
        'serving' => '正在服务',
        'patient_queue_theme' => '病人队列主题',
        'upload_video' => '上传视频',
        'video' => '视频',
        'allowed_video_types' => '允许的文件类型：MP4、WebM、MOV。',
        'live' => '居住',
        'total_in_queue' => '队列总数',
    ...
    'two_factor_auth' => [
        'enable_two_factor' => '启用双因素身份验证',
        'scan_qr_code' => '使用 Google Authenticator 或类似应用扫描二维码。或者使用代码',
        'loading' => '正在加载双重验证设置...',
        'enter_otp' => '输入一次性密码',
        'verify_and_enable' => '验证并启用双因素身份验证',
        'recovery_codes' => '恢复代码',
        'recovery_codes_warning' => '请保存这些代码。它们不会再次显示。',
        'download_codes' => '下载代码',
        'regenerate_codes' => '重新生成代码',
        'qr_error' => '二维码加载错误，请刷新页面。',
        'disable_two_factor' => '禁用双因素身份验证',
        'two_factor_protected' => '您的账户已启用双重身份验证保护。',
        'disable_2fa' => '禁用 2FA',
        'verify_2fa' => '验证双因素身份验证',
        'verify_your_account' => '验证您的帐户',
        'one_time_password' => '一次性密码',
        'enter_verification_code' => '输入验证码',
        'verify' => '核实',
        'code_not_found' => '如果找不到您的代码，请使用有效的恢复代码或联系客服。',
        'code_generated_successfully' => '代码生成成功。',
        'session_expired' => '会话已过期，请重试。',
        'invalid_auth_code' => '验证码无效。',
        'two_factor_enabled_successfully' => '双因素认证已成功启用。',
        'recovery_codes_regenerated_successfully' => '恢复代码已成功重新生成。',
        'two_factor_disabled_successfully' => '双因素认证已成功禁用。',
