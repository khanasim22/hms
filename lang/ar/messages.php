...
'prefix_tooltip' => 'أدخل أي بادئة تحتوي على حروف وأرقام (مثال: ABC، ABC01). سيقوم النظام بزيادة الرقم الأخير تلقائيًا (ABC01 → ABC02). إذا لم يتم العثور على رقم، فسيبدأ الترقيم من 1 أو من رقم البداية الذي قمت بتعيينه.',
    ...
    'user' => [
        ...
        'please_first_create_doctor_department' => 'يرجى أولاً إنشاء قسم الأطباء',
    ],
    ...
    'complaints' => [
        ...
        'complaint_updated_successfully' => 'تم تحديث الشكوى بنجاح',
        'complaint_deleted_successfully' => 'تم حذف الشكوى بنجاح',
        'pending' => 'قيد الانتظار',
        'in_progress' => 'جاري التنفيذ',
        'resolved' => 'تم الحل',
        'rejected' => 'مرفوض',
        'no_response_available' => 'لا يوجد رد متاح',
    ...
    'queue' => [
        ...
        'live_patient_queue' => 'قائمة انتظار المرضى المباشرين',
        'refreshing' => 'منعش...',
        'refresh_now' => 'قم بالتحديث الآن',
        'refreshing_in' => 'منعش في',
        'serving' => 'التقديم',
        'patient_queue_theme' => 'موضوع قائمة انتظار المرضى',
        'upload_video' => 'تحميل الفيديو',
        'video' => 'فيديو',
        'allowed_video_types' => 'أنواع الملفات المسموح بها: MP4، WebM، MOV.',
        'live' => 'Live',
        'total_in_queue' => 'إجمالي عدد الأشخاص في قائمة الانتظار',
        'auto_refresh_active' => 'التحديث التلقائي مُفعّل',
    ...
    'two_factor_auth' => [
        ...
        'scan_qr_code' => 'قم بمسح رمز QR باستخدام Google Authenticator أو تطبيق مشابه، أو استخدم الرمز',
        'loading' => 'جارٍ تحميل إعدادات المصادقة الثنائية...',
        'enter_otp' => 'أدخل رمز OTP',
        'verify_and_enable' => 'تحقق وتفعيل 2FA',
        'recovery_codes' => 'رموز الاسترداد',
        'recovery_codes_warning' => 'احفظ هذه الرموز. لن يتم عرضها مرة أخرى.',
        'download_codes' => 'تحميل الرموز',
        'regenerate_codes' => 'إعادة إنشاء الرموز',
        'qr_error' => 'حدث خطأ أثناء تحميل QR. قم بتحديث الصفحة.',
        'disable_two_factor' => 'تعطيل المصادقة الثنائية',
        'two_factor_protected' => 'حسابك محمي بالمصادقة الثنائية.',
        'disable_2fa' => 'تعطيل 2FA',
        'verify_2fa' => 'التحقق من المصادقة الثنائية',
        'verify_your_account' => 'تحقق من حسابك',
        'one_time_password' => 'كلمة مرور لمرة واحدة',
        'enter_verification_code' => 'أدخل رمز التحقق',
        'verify' => 'تحقق',
        'code_not_found' => 'إذا لم تتمكن من العثور على الرمز، استخدم رمز استرداد أو تواصل مع الدعم.',
        'code_generated_successfully' => 'تم إنشاء الرمز بنجاح.',
        'session_expired' => 'انتهت الجلسة. حاول مرة أخرى.',
        'invalid_auth_code' => 'رمز غير صالح.',
        'two_factor_enabled_successfully' => 'تم تفعيل المصادقة الثنائية بنجاح.',
        'recovery_codes_regenerated_successfully' => 'تم إعادة إنشاء رموز الاسترداد بنجاح.',
