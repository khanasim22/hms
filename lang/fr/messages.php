...
return [
    ...
    */
    ...
    'user' => [
        ...
        'please_first_create_doctor_department' => 'Veuillez d l\'abord créer un service médical',
    ],
    ...
    'complaints' => [
        ...
        'complaint_updated_successfully' => 'Plainte mise à jour avec succès',
        'complaint_deleted_successfully' => 'Plainte supprimée avec succès',
        'pending' => 'En attente',
    ...
    'queue' => [
        ...
        'live_patient_queue' => 'File d\'attente des patients en direct',
        'refreshing' => 'Rafraîchissante...',
        'refresh_now' => 'Actualiser maintenant',
        'refreshing_in' => 'Rafraîchissant dans',
        'serving' => 'Portion',
        'patient_queue_theme' => 'Thème de la file d\'attente des patients',
        'upload_video' => 'Télécharger la vidéo',
        'video' => 'Vidéo',
        'allowed_video_types' => 'Types de fichiers autorisés : MP4, WebM, MOV.',
        'live' => 'En direct',
        'total_in_queue' => 'Total dans la file d\'attente',
        'auto_refresh_active' => 'Actualisation automatique activée',
    ...
    'two_factor_auth' => [
        ...
        'scan_qr_code' => 'Scannez le QR code avec Google Authenticator ou une app similaire. Ou utilisez le code',
        'loading' => 'Chargement de la configuration 2FA...',
        'enter_otp' => 'Entrer le code OTP',
        'verify_and_enable' => 'Vérifier et activer 2FA',
        'recovery_codes' => 'Codes de récupération',
        'recovery_codes_warning' => 'Enregistrez ces codes. Ils ne seront plus affichés.',
        'download_codes' => 'Télécharger les codes',
        'regenerate_codes' => 'Régénérer les codes',
        'qr_error' => 'Erreur de chargement du QR. Actualisez la page.',
        'disable_two_factor' => 'Désactiver l’authentification à deux facteurs',
        'two_factor_protected' => 'Votre compte est protégé par l’authentification à deux facteurs.',
        'disable_2fa' => 'Désactiver 2FA',
        'verify_2fa' => 'Vérifier l’authentification à deux facteurs',
        ...
        'verify' => 'Vérifier',
        'code_not_found' => 'Si vous ne trouvez pas le code, utilisez un code de récupération ou contactez le support.',
        'code_generated_successfully' => 'Code généré avec succès.',
        'session_expired' => 'Session expirée. Réessayez.',
        'invalid_auth_code' => 'Code invalide.',
        'two_factor_enabled_successfully' => 'Authentification à deux facteurs activée avec succès.',
        'recovery_codes_regenerated_successfully' => 'Codes de récupération régénérés avec succès.',
        'two_factor_disabled_successfully' => '2FA désactivée avec succès.',
