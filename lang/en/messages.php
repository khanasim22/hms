...
return [
    ...
    */
    ...
    'user' => [
        ...
        'please_first_create_doctor_department' => 'Please first create doctor department',
    ],
   ...
   'queue' => [
        ...
        'serving' => 'Serving',
        'patient_queue_theme' => 'Patient Queue Theme',
        'upload_video' => 'Upload Video',
        'video' => 'Video',
        'allowed_video_types' => 'Allowed file types: MP4, WebM, MOV.',
        'live' => 'Live',
    ...
    'two_factor_auth' => [
        ...
        'scan_qr_code' => 'Scan the QR code using Google Authenticator or similar app. Or use code',
        'loading' => 'Loading 2FA setup...',
        'enter_otp' => 'Enter OTP',
        'verify_and_enable' => 'Verify & Enable 2FA',
        'recovery_codes' => 'Recovery Codes',
        'recovery_codes_warning' => 'Save these codes. They will not be shown again.',
        'download_codes' => 'Download Codes',
        'regenerate_codes' => 'Regenerate Codes',
        'qr_error' => 'Error loading QR. Refresh the page.',
        ...
        'verify' => 'Verify',
        'code_not_found' => 'If you can not find your code, use a valid recovery code or contact support.',
        ...
        'two_factor_enabled_successfully' => 'Two-factor authentication is enabled successfully.',
        'recovery_codes_regenerated_successfully' => 'Recovery codes regenerated successfully.',
        'two_factor_disabled_successfully' => '2FA has been disabled successfully.',
