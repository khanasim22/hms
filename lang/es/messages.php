...
return [
    ...
    */
    ...
    'user' => [
        ...
        'please_first_create_doctor_department' => 'Por favor, primero cree un departamento de médicos',
    ],
    ...
    'complaints' => [
        ...
        'response' => 'Respuesta',
        'hold' => 'Sostener',
        'complaint_submitted_successfully' => 'Queja presentada con éxito',
        'complaint_updated_successfully' => 'Queja actualizada correctamente',
        'complaint_deleted_successfully' => 'Queja eliminada con éxito',
        'pending' => 'Pendiente',
        'in_progress' => 'Pendiente',
        'resolved' => 'Pendiente',
        'rejected' => 'Pendiente',
        'no_response_available' => 'No hay respuesta disponible',
    ...
    'queue' => [
        ...
        'live_patient_queue' => 'Cola de pacientes en vivo',
        'refreshing' => 'Refrescante...',
        'refresh_now' => 'Actualizar ahora',
        'refreshing_in' => 'Refrescante en',
        'serving' => 'Servicio',
        'patient_queue_theme' => 'Tema de cola de pacientes',
        'upload_video' => 'Subir vídeo',
        'video' => 'Video',
        'allowed_video_types' => 'Tipos de archivo permitidos: MP4, WebM, MOV.',
        'live' => 'Vivir',
        'total_in_queue' => 'Total en cola',
        'auto_refresh_active' => 'Actualización automática activa',
        'all_patients' => 'Todas las pacientes',
    ...
    'two_factor_auth' => [
        ...
        'scan_qr_code' => 'Escanea el código QR con Google Authenticator o app similar. O usa el código',
        'loading' => 'Cargando configuración 2FA...',
        'enter_otp' => 'Ingresar OTP',
        'verify_and_enable' => 'Verificar y activar 2FA',
        'recovery_codes' => 'Códigos de recuperación',
        'recovery_codes_warning' => 'Guarda estos códigos. No se mostrarán nuevamente.',
        'download_codes' => 'Descargar códigos',
        'regenerate_codes' => 'Regenerar códigos',
        'qr_error' => 'Error al cargar QR. Actualiza la página.',
        'disable_two_factor' => 'Desactivar autenticación de dos factores',
        'two_factor_protected' => 'Tu cuenta está protegida con autenticación de dos factores.',
        'disable_2fa' => 'Desactivar 2FA',
        'verify_2fa' => 'Verificar autenticación de dos factores',
        ...
        'verify' => 'Verificar',
        'code_not_found' => 'Si no encuentras el código, usa un código de recuperación o contacta soporte.',
        'code_generated_successfully' => 'Código generado correctamente.',
        'session_expired' => 'Sesión expirada. Intenta de nuevo.',
        'invalid_auth_code' => 'Código inválido.',
        'two_factor_enabled_successfully' => 'Autenticación de dos factores activada correctamente.',
        'recovery_codes_regenerated_successfully' => 'Códigos de recuperación regenerados correctamente.',
        'two_factor_disabled_successfully' => '2FA desactivada correctamente.',
